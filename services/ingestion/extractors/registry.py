...
from services.ingestion.errors import UnsupportedFormatError
from services.ingestion.extractors.image import extract_image, is_image_extension
from services.ingestion.extractors.spreadsheet import (
...
def extract_file(path: str, filename: str) -> tuple[list[ExtractedBlock], str]:
    ...
    from services.ingestion.extractors.pdf import extract_pdf

...
from services.ingestion.extractors.pdf import count_pdf_vlm_work
from services.ingestion.extractors.registry import get_extension


def should_process_in_background(path: str, filename: str) -> bool:
    from services.ingestion.config import INGEST_ASYNC_IMAGE_THRESHOLD
